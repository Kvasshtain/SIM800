...
#define   NOICE_DURATION            250               // длительность шумового импульса в тиках системного таймера
                                                      // (например при частоте таймера 1КГц число 250 - приблизительно 0,25 секунды)
