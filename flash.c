...
//	return FLASH_Read_String(start_DATA_Page_59, MAX_SIZE_STR_PHONE_8 * string_cell, data_string, 4);
}
//***************************************************************************************************************************************
...
uint8_t FLASH_Write_Byte(uint32_t page, uint16_t byte_shift, uint8_t * read_byte)
{
	uint32_t i;
	...
	temp_buf[byte_shift - byte_shift%4].i8[byte_shift%4] = * read_byte; // изменяем данные
